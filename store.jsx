...
const MOCK_USERS: User[] = [
  ...
  },
  {
    id: "u2",
    name: "John Creator",
    email: "creator@arena.com",
    password: "123",
    role: UserRole.CREATOR,
    photoUrl:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
    bio: "Senior Designer & Contest Host",
  },
  {
    id: "u3",
    name: "Alice Gamer",
...
const MOCK_CONTESTS: Contest[] = [
  {
    ...
    description:
      "Create a clean, modern logo for a tech startup focusing on AI. The brand represents future, speed, and intelligence. We need something iconic that stands out in the app store.",
    instruction:
      "Submit a PNG and SVG version of your logo. Must use blue and white color palette.",
    image:
  ...
  },
  {
    ...
    description:
      "Write a 1000-word article on how VR will change gaming in 2030. Focus on immersive storytelling and hardware evolution. The tone should be excited yet analytical.",
  ...
  },
  {
    ...
    description:
      "Draft a business model for a sustainable local business that reduces plastic waste. We are looking for innovative supply chain solutions and marketing strategies.",
  ...
  },
  {
    ...
    description:
      "Build a responsive analytics dashboard using React and Tailwind CSS. Must include dark mode toggle, charts using Recharts, and a clean sidebar navigation.",
  ...
  },
  {
    ...
    description:
      "Write a comprehensive review of the latest Elden Ring DLC. Focus on boss mechanics, new weapons, and lore implications. Spoilers allowed but must be marked.",
  ...
  },
  {
    ...
    description:
      "Create a cyberpunk style illustration of a futuristic city. Focus on neon lighting, rain effects, and verticality. 4K resolution required.",
    instruction: "High-res JPG required.",
    image:
      "https://images.unsplash.com/photo-1535868463750-c78d9543614f?auto=format&fit=crop&q=80&w=1200",
    category: ContestCategory.DESIGN,
    price: 20,
    prizeMoney: 800,
  ...
  },
  {
    ...
    description:
      "Design a concept for a self-sustaining home in a desert environment. Must include water recycling systems and solar power integration.",
  ...
  },
  {
    ...
    description:
      "Design a complete UI kit for a fitness tracking application. Include 15+ screens, component library, and interactive prototype.",
  ...
  },
  {
    ...
    description:
      "Capture the essence of city nightlife. We are looking for high-contrast, vibrant street photography that tells a story of the urban environment after dark.",
  ...
  },
  {
    ...
    description:
      "Create a sound effect pack for a retro 8-bit platformer. Includes jump, coin collect, damage, and game over sounds.",
    instruction: "Submit a ZIP file with WAV/MP3.",
    image:
      "https://images.unsplash.com/photo-1593108603685-6bbd688c2323?auto=format&fit=crop&q=80&w=1200",
    category: ContestCategory.GAMING,
    price: 5,
    prizeMoney: 250,
  ...
  },
  {
    ...
    description:
      "Visualize global temperature anomalies from 1880 to 2023 using Python or D3.js. The goal is clarity and impact.",
  ...
  },
  {
    ...
    description:
      'Create a 2-minute short film interpreting the theme "Silence". Any genre accepted (Horror, Drama, Experimental).',
  ...
  },
  {
    ...
    description:
      "Write a UX case study for a banking app for teenagers. Focus on financial literacy gamification.",
    instruction: "Medium article link or PDF.",
    image:
      "https://images.unsplash.com/photo-1565514020176-dbf2277e3c60?auto=format&fit=crop&q=80&w=1200",
    category: ContestCategory.BUSINESS,
    price: 15,
    prizeMoney: 1200,
    deadline: new Date(Date.now() + 86400000 * 10).toISOString(),
  ...
  },
  {
    ...
    title: "Rust CLI Tool",
    description:
      "Build a fast, efficient CLI tool in Rust that compresses images. Must benchmark against ImageMagick.",
  ...
  },
  {
    ...
    description:
      "Optimize a transformer model to generate creative poetry. The model with the lowest perplexity and highest creativity score wins.",
  ...
  },
  {
    ...
    description:
      "Write the opening scene for a movie set on the first Mars colony. Focus on dialogue and atmospheric world-building.",
    instruction: "PDF format, industry standard script format.",
    image:
      "https://images.unsplash.com/photo-1614728853913-1e221a6572e0?auto=format&fit=crop&q=80&w=1200",
    category: ContestCategory.WRITING,
    price: 10,
    prizeMoney: 1500,
  ...
  },
  {
    ...
    description:
      "Design a viral marketing campaign for a new energy drink. Include storyboard, hashtag strategy, and influencer list.",
  ...
  },
  {
    ...
    description:
      "Create an abstract, soulful album cover for a modern jazz quartet. Think Blue Note Records meets digital art.",
  ...
  },
  {
    ...
    description:
      "Create a single-level 2D platformer with unique gravity mechanics. Assets can be premade, code must be original.",
  ...
  },
  {
    ...
    description:
      "Capture the beauty of avian life in motion. Sharp focus, natural lighting, and zero AI generation allowed.",
...
const MOCK_SUBMISSIONS: Submission[] = [
  {
    ...
    contestId: "c2",
    userId: "u3",
    taskUrl: "http://docs.google.com/sample",
  ...
  },
  {
    ...
    contestId: "c1",
    userId: "u4",
    taskUrl: "http://dribbble.com/sample",
    submittedAt: new Date().toISOString(),
    paymentStatus: "paid",
  },
  {
...
interface AppContextType {
  ...
  contests: Contest[];
  addContest: (
    contest: Omit<Contest, "id" | "participantsCount" | "status" | "winnerId">
  ) => void;
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const addContest = (
    data: Omit<Contest, "id" | "participantsCount" | "status" | "winnerId">
  ) => {
  ...
  const joinContest = async (contestId: string, paymentDetails: any) => {
    ...
    if (
      submissions.some(
        (s) => s.contestId === contestId && s.userId === currentUser.id
      )
    )
      return;
